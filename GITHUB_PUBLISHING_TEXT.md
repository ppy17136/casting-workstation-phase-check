...
面向砂型铸造典型件的本地辅助工作站原型，用于组织工艺方案、仿真结果、工艺卡、质检清单与成果包导出。
...
本仓库面向“砂型铸造工艺图与工艺卡的一体化建模及仿真辅助优化”项目，提供一个可运行、可展示、可归档的桌面辅助工作站原型。

## 4. 首次公开提交说明（Commit Message）建议
...
- 这是“辅助工作站原型”，不是工业级闭环控制系统
- 当前重点是“圆盖典型件阶段演示”，不是全部案例都已完成
- 软件的价值在于支撑“工艺图—工艺卡—仿真校核”一体化表达
